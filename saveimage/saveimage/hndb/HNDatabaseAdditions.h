...
/** Category of additions for `<HNDatabase>` class.
...
@interface HNDatabase (HNDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `HNDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `HNResultSet` of schema; `nil` on error.
